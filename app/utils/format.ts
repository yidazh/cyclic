 ...
 */
export function formatTime(timestamp: number, format24h: boolean = true): string {
  const date = new Date(timestamp);
 ...
 */
export function formatDateTime(timestamp: number, format24h: boolean = true): string {
